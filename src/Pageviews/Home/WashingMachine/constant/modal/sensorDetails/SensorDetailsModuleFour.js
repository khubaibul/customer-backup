...
const SensorDetailsModuleFour = ({
  ...
  return (
    <Modal
      ...
      open={sensorDetailsModuleFourOpen}
    >
      <Container
        sx={{
          width: "60%",
...
export default SensorDetailsModuleFour;
