...
const SensorDetailsModuleTwo = ({
  sensorDetailsModuleTwoOpen,
  setSensorDetailsModuleTwoOpen,
  sensorDetailsModuleThreeOpen,
  setSensorDetailsModuleThreeOpen,
}) => {
  const goNext = () => {
    setSensorDetailsModuleTwoOpen(!sensorDetailsModuleTwoOpen);
  ...
  return (
    <Modal
      ...
      open={sensorDetailsModuleTwoOpen}
    >
      <Container
        sx={{
          width: "35%",
...
export default SensorDetailsModuleTwo;
