...
const CreateInvoiceModal = ({
  ...
  console.log(reservation?.user?.showaUser?.addresses[0]?.address);
  return (
    <Box>
      {/* {isCustomerListOpen && (
        <CustomerListModal
          ...
          >
            ...
            <Box>
              ...
              >
                ...
                <img
                  src={
                    reservation?.user?.showaUser?.photoUrl
                      ? reservation?.user?.showaUser?.photoUrl
                      : user
                  }
                  alt=""
                ...
                <Box>
                  ...
                  >
                    {reservation?.user?.showaUser?.name?.firstName +
                      "  " +
                      reservation?.user?.showaUser?.name?.lastName}
                  </Typography>
                  <Typography
                    sx={{
                      color: "#5A6872",
                  ...
                  >
                    {reservation?.user?.showaUser?.addresses[0]?.address
                      ?.street +
                      ", " +
                      reservation?.user?.showaUser?.addresses[0]?.address
                        ?.city +
