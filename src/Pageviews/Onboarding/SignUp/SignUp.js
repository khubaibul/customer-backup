  ...
  const handleSignUp = (e) => {
    ...
    if (password === confirmPassword) {
      dispatch(createUser({ email, password })).then((result) => {
        ...
        // dispatch(updateUser({ name, photo: data.url })).then((result) => {
        //   e.target.reset();
        ...
        >
          ...
          >
            <Box sx={{ width: "100%" }}>
              ...
              <Box
                sx={{ display: "flex", alignItems: "center", marginY: "18px" }}
              >
                <Divider sx={{ flex: 1 }} />
              ...
              >
                    ...
                    label={
                      <Box>
                        <Typography sx={{ fontSize: "12px" }}>
                          ...
                          , and our default Notification{" "}
                          <span style={{ color: "#24459C" }}>Settings.</span>.
                        </Typography>
                      </Box>
                    }
                    sx={{ color: "gray" }}
                ...
                >
                  {isLoading ? <ProgressingLoader /> : " Sign Up"}
                </Button>
              </form>
            </Box>
          </Box>
